...
public TDALista<T> intercalar(TDALista<T> otra) {
    ...
    Nodo<T> actual2 = ((ListaEnlazada<T>) otra).cabeza;

    // intercalar mientras ambos tengan elementos
    while (actual1 != null && actual2 != null) {

        resultado.agregar(actual1.getDato());
    ...
    // resto de la primera lista
    while (actual1 != null) {
        resultado.agregar(actual1.getDato());
        actual1 = actual1.getSiguiente();
    }

    // resto de la segunda lista
    while (actual2 != null) {
        resultado.agregar(actual2.getDato());
        actual2 = actual2.getSiguiente();
    }
