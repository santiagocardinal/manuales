...
public class ColaCircularListaEnlazadaTest 
{

    private ColaCircularListaEnlazada<Integer> cola;

    @Before
    public void setUp() 
    {
        cola = new ColaCircularListaEnlazada<>();
    }
    ...
    @Test
    public void testPoneYQuitaUnSoloElemento() 
    {
        cola.poneEnCola(42);
        assert(cola.quitaDeCola().equals(42));
        assertTrue(cola.vacia());
    }
