...
public class ClasePrincipalTest {
    ...
    @Test
public void testRotarCola() throws IOException {
    ...
    // ahora el frente debería ser 3
    // lo chequeamos indirectamente

    assertTrue(cp.buscarPorNumero(3));
    assertEquals(5, cp.tamano());
}
}